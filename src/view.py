...
# Criando o frame para as colunas
...
# Coluna Done
    ...
    def update_task_list(self, tasks):
        ...
        def get_selected_task_index(self, listbox_name):
            if listbox_name == "backlog_listbox":
                listbox = self.backlog_listbox
            elif listbox_name == "todo":
                listbox = self.todo_listbox
            elif listbox_name == "progress":
                listbox = self.progress_listbox
            elif listbox_name == "done":
                listbox = self.done_listbox
            else:
                return None
